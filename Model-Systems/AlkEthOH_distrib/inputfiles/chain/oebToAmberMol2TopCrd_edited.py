...
def hasAmberParams( mol, leaprc_string):
    ...
    # VTL, add atom atoms for c0 (methane), c1302 (water)
...
for mol in ifs.GetOEMols():
    # VTL, adapted to only run c0 and c1302 molecules of entire .oeb file
    if (oechem.OECount(mol, oechem.OEIsHeavy()) == 1) and hasAmberParams(mol,cmd_string):
